  ...
  return (
    <form className="form">
      ...
      <input
        ...
        style={{
          borderColor: email ? (validEmail ? "green" : "red") : "gray",
        }}
        onChange={(e) => {
      ...
      <input
        ...
        style={{borderColor: password ? (validPassword ? "green" : "red") : "gray",}}
        onChange={(e) => {
      ...
      <input
        ...
        style={{borderColor: confirmPassword ? (validConfirmPassword ? "green" : "red") : "gray",}}
        onChange={(e) => {
